<main id="content" role="main" class="main commerce-landing">
    ...
    <a href="product-listing.amp.html" class="text-decoration-none block">
      ...
      <div class="commerce-hero-content commerce-hero-content-theme-primary flex justify-center flex-column md-mx-auto md-p0">
        <div class="commerce-hero-align md-mx-auto">
          <h2 class="commerce-hero-content-title h4 md-h1 caps md-mb2 md-pl4">Dice Bags</h2>
          <p class="commerce-hero-content-body">Licensed and Novelty cotton dice bags lined with soft polyester satin that every RPGer needs to get their game on!</p>
  ...
  <section class="commerce-hero-content-wrapper center overflow-hidden">
    <a href="blog-listing.amp.html" class="text-decoration-none block">
      ...
      <div class="commerce-hero-content commerce-hero-content-theme-primary flex justify-center flex-column md-mx-auto md-p0">
        <div class="commerce-hero-align md-mx-auto">
          <h2 class="commerce-hero-content-title h4 md-h1 caps md-mb2 md-pl4">Displays</h2>
          <p class="commerce-hero-content-body">Learn about the importance of great displays and how they increase your sales.</p>
  ...
  <section class="commerce-hero-content-wrapper center overflow-hidden">
    <a href="<?=absolute_url()?>about" class="text-decoration-none block">
      ...
      <div class="commerce-hero-content commerce-hero-content-theme-primary flex justify-center flex-column md-mx-auto md-p0">
        <div class="commerce-hero-align md-mx-auto">
          <h2 class="commerce-hero-content-title h4 md-h1 caps md-mb2 md-pl4">The Brains and the Other Brains</h2>
          <p class="commerce-hero-content-body">Ever wonder how 25th Hour Crafts got its start (and name)? Now you too can know!</p>
          <div class="ampstart-btn ampstart-btn-secondary caps md-ml4">read</div>
        </div>
      </div>
    </a>
